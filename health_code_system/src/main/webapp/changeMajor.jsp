        ...
        <div class="login-form-area mg-t-30 mg-b-40">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form id="adminpro-form" class="adminpro-form" action="MajorChangeInfo?tno=${teachers.tno}" method="post">
                        <div class="col-lg-4">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="name" value="${majors.name}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="no" value="${majors.no}" readonly>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="dean" value="${majors.dean}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="college" value="${majors.college}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
