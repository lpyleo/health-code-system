                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryStudent?tno=${teachers.tno}" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入学生姓名、学号或学院（支持模糊查询）：</span>
                                    ...
                                    %>
                                    <div>
                                        <form action="ImportExcelStudents?tno=${teachers.tno}" method="post" enctype="multipart/form-data" style="position: relative;">
                                    ...
                                    <span style="position:relative;right: -110px">
                                            <a href="addStudent.jsp?tno=${teachers.tno}" title="Add student"><i style="position:relative;height: 32px;left: 215px;top: 33px;right: -2.5px;background: #303030;border: 5px solid #303030;color:#fff;padding-top: 3px;" class="fa fa-user-plus fa-lg"></i></a>
                                    </span>
                                    <%
                                        }
                                    %>
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="id" data-editable="true">身份证号</th>
                                            <th data-field="company" data-editable="true">学号</th>
                                            <th data-field="college" data-editable="true">学院</th>
                                            <th data-field="major" data-editable="true">专业</th>
                                            <th data-field="class" data-editable="true">班级</th>
                                            <%
                                                if(role.equals("系统管理员")){
                                            %>
                                        ...
                                        <tbody>
                                        <c:forEach var="students" items="${sessionScope.students}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${students.sname}</td>
                                                <td>${students.sidnumber}</td>
                                                <td>${students.sno}</td>
                                                <td>${students.scollege}</td>
                                                <td>${students.smajor}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="StudentChange?studentno=${students.sno}&teacherno=${teachers.tno}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="DeleteStudent?studentno=${students.sno}&teacherno=${teachers.tno}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                                <%
                                                    }
