                                    ...
                                    <div class="col-lg-12">
                                        <div class="login-title" style="text-align: center;">
                                            ...
                                            <div align="center">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                <a href="stuDailyReport.jsp?tno=${students.sno}"><font color="white">修改</font></a>
                                            </div>
                                            <div align="center">
                                                <%
                                                    if(color.equals("金")){
                                                %>
                                                <img style="border: 5px solid gold;border-radius: 5px;" src="${pageContext.request.contextPath}/MiddleStuHealthCode" alt="健康码">
                                                <%
                                                }else {
                                                %>
                                                <img src="${pageContext.request.contextPath}/MiddleStuHealthCode" alt="健康码">
                                                <%
                                                    }
                                                %>
                                            </div>
