...
@WebServlet(name = "ImportExcelStudents", value = "/ImportExcelStudents")
@MultipartConfig
public class ImportExcelStudents extends HttpServlet {
    // 获取文件名
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(isXls(filename)){
            ...
            RequestDispatcher rd= request.getRequestDispatcher("/ImportExcelInfoStudents");
