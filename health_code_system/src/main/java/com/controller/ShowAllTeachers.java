...
@WebServlet(name = "ShowAllTeachers", value = "/ShowAllTeachers")
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            if(teachers.getTrole().equals("院级管理员")){
                tea=new ArrayList<Teachers>(dao.findByFuzzyName(teachers.getTcollege()));
            }else {
                tea = new ArrayList<Teachers>(dao.findAllTeachers());
            }
