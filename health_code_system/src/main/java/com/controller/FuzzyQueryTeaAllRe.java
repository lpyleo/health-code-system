...
@WebServlet(name = "FuzzyQueryTeaAllRe", value = "/FuzzyQueryTeaAllRe")
public class FuzzyQueryTeaAllRe extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (teachers.getTrole().equals("院级管理员")){
            try {
                teaCodes=dao.teaCollegeCodeFuzzyQuery(teachers.getTcollege(),name,time);
            } catch (DaoException e) {
                e.printStackTrace();
            }
        }else{
            try {
                teaCodes=dao.teaCodeFuzzyQuery(name,time);
            } catch (DaoException e) {
                e.printStackTrace();
            }
        }
        ...
        RequestDispatcher rd= getServletContext().getRequestDispatcher("/fuzzyQueryTeaAllRe.jsp");
