...
@WebServlet(name = "ImportExcelTeachers", value = "/ImportExcelTeachers")
@MultipartConfig
public class ImportExcelTeachers extends HttpServlet {
    // 获取文件名
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(isXls(filename)){
            ...
            RequestDispatcher rd= request.getRequestDispatcher("/ImportExcelInfoTeachers");
