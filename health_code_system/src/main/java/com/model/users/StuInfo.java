...
public class StuInfo {
    ...
    public StuInfo(String name, String idno, String no, String phone, String select1, String select2, String select3, String select4, String select5, String select6) {
        this.name = name;
        this.idno = idno;
        this.no = no;
        this.phone = phone;
