...
<div class="container">
    <form action="TeaLoginServlet" class="needs-validation" novalidate>
        <div align="center">
            <img src="static/images/logo.png" alt="寰宇">
            <h2 style="font-size: 20px;">教师/学生登录</h2>
        </div>
        <br>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="no" name="no" placeholder="请输入您的工号/学号" pattern="[0-9]{5,12}" required>
            <div class="invalid-feedback">请输入正确的工号/学号</div>
        </div>
        <div class="form-group">
            <label for="password">密码</label>
            <input type="password" class="form-control" id="password" name="password" placeholder="请输入您的密码（身份证后八位）" pattern="[A-Za-z0-9]{8}" required>
            <div class="invalid-feedback">请输入正确的密码（身份证后八位）</div>
        </div>
