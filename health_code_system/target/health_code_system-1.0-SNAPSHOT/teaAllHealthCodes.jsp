                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryTeaAllHD" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入姓名、工号、学院或健康码颜色（支持模糊查询）：</span>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tbody>
                                        <c:forEach var="teachers1" items="${sessionScope.teachers1}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${teachers1.tname}</td>
                                                <td>${teachers1.tno}</td>
                                                <td>${teachers1.tcollege}</td>
                                                <c:if test="${teachers1.tcodecolor eq ''}">
                                                    <td>未打卡</td>
                                                </c:if>
                                                <c:if test="${teachers1.tcodecolor eq '绿'}">
                                                    <td>绿</td>
                                                </c:if>
                                                <c:if test="${teachers1.tcodecolor eq '黄'}">
                                                    <td>黄</td>
                                                </c:if>
                                                <c:if test="${teachers1.tcodecolor eq '红'}">
                                                    <td>红</td>
                                                </c:if>
                                                <c:if test="${teachers1.tcodecolor eq '金'}">
                                                    <td>金</td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
