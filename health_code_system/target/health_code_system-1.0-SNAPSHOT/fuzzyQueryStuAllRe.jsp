                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div class="form-group data-custon-pick data-custom-mg" id="data_5">
                                        <label>请选择查询时间：</label>
                                        <form action="StuAllOneDayReport" method="post">
                                    ...
                                    <br>
                                    <div>
                                        <form action="FuzzyQueryStuAllRe" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入姓名、学号、学院、专业、班级或打卡状态（支持模糊查询）：</span>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="company" data-editable="true">是否打卡</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <c:forEach var="stuCodes" items="${sessionScope.stuCodes}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${stuCodes.name}</td>
                                                <td>${stuCodes.no}</td>
                                                <td>${stuCodes.college}</td>
                                                <td>${stuCodes.major}</td>
                                                <td>${stuCodes.classes}</td>
                                                <td>${stuCodes.field}</td>
                                                <c:if test="${stuCodes.action eq '0'}">
                                                    <td>未打卡</td>
                                                </c:if>
                                                <c:if test="${stuCodes.action eq '1'}">
                                                    <td>已打卡</td>
                                                </c:if>
                                                <c:if test="${stuCodes.action eq '2'}">
                                                    <td>已打卡</td>
                                                </c:if>
                                                <c:if test="${stuCodes.action eq '3'}">
                                                    <td>已打卡</td>
                                                </c:if>
                                                <c:if test="${stuCodes.action eq '4'}">
                                                    <td>已打卡</td>
                                                </c:if>
                                            </tr>
                                        </c:forEach>
