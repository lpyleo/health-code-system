        ...
        <div class="login-form-area mg-t-30 mg-b-40">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form id="adminpro-form" class="adminpro-form" action="StudentAdd?tno=${teachers.tno}" method="post">
                        <div class="col-lg-4">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <select class="form-control custom-select-value" name="major" id="major">
                                                <option value=""></option>
                                                <c:forEach var="maj" items="${sessionScope.maj}" varStatus="status">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <select class="form-control custom-select-value" name="class" id="class">
                                                <option value=""></option>
                                                <c:forEach var="cla" items="${sessionScope.cla}" varStatus="status">
