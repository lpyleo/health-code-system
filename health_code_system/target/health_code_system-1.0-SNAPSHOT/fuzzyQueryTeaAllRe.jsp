                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div class="form-group data-custon-pick data-custom-mg" id="data_5">
                                        <label>请选择查询时间：</label>
                                        <form action="TeaAllOneDayReport" method="post">
                                    ...
                                    <br>
                                    <div>
                                        <form action="FuzzyQueryTeaAllRe" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入姓名、工号、学院或打卡状态（支持模糊查询）：</span>
