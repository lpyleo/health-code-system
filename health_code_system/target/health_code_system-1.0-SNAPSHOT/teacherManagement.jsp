                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="TeacherChange?teano=${tea.tno}&teacherno=${teachers.tno}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="DeleteTeacher?teano=${tea.tno}&teacherno=${teachers.tno}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                                <%
                                                    }
