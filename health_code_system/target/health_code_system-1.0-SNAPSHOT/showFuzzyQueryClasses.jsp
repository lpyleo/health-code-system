                        ...
                        <div class="sparkline8-list shadow-reset">
                            ...
                            <div class="sparkline8-graph">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div>
                                        <form action="FuzzyQueryClass?tno=${teachers.tno}" method="post" style="position:relative;float:left;">
                                            <span style="color: #fff">请输入班级名、编号、班主任名字、学院名或专业名（支持模糊查询）：</span>
                                    ...
                                    %>
                                    <div>
                                        <form action="ImportExcelClasses?tno=${teachers.tno}" method="post" enctype="multipart/form-data" style="position: relative;">
                                    ...
                                    <span style="position:relative;right: -110px">
                                            <a href="addClass.jsp?tno=${teachers.tno}" title="Add class"><i style="position:relative;height: 32px;left: 215px;top: 33px;right: -2.5px;background: #303030;border: 5px solid #303030;color:#fff;padding-top: 3px;" class="fa fa-user-plus fa-lg"></i></a>
                                    </span>
                                    <%
                                        }
                                    %>
                                    <table id="table" data-toggle="table" data-pagination="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                        ...
                                        <tr>
                                            ...
                                            <th data-field="name" data-editable="true">班级名</th>
                                            <th data-field="id" data-editable="true">班级编号</th>
                                            <th data-field="company" data-editable="true">班主任</th>
                                        ...
                                        <tbody>
                                        <c:forEach var="classes" items="${sessionScope.classes}" varStatus="status">
                                            <tr>
                                                <td></td>
                                                <td>${classes.name}</td>
                                                <td>${classes.no}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group project-list-action">
                                                        <a href="ClassChange?classno=${classes.no}&teacherno=${teachers.tno}"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> 修改</button></a>
                                                        <a href="DeleteClass?classno=${classes.no}&teacherno=${teachers.tno}"><button class="btn btn-white btn-xs"><i class="fa fa-pencil"></i> 删除</button></a>
                                                    </div>
                                                </td>
                                                <%
                                                    }
