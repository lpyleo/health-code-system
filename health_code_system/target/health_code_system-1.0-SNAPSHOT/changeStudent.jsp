        ...
        <div class="login-form-area mg-t-30 mg-b-40">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <form id="adminpro-form" class="adminpro-form" action="StudentChangeInfo?tno=${teachers.tno}" method="post">
                        <div class="col-lg-4">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="name" value="${students.sname}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="idnumber" value="${students.sidnumber}">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="no" value="${students.sno}" readonly>
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="college" value="${students.scollege}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="major" value="${students.smajor}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="login-input-area">
                                            <input type="text" name="class" value="${students.sclass}">
                                            <i class="fa fa-lock login-user"></i>
                                        </div>
                                    </div>
                                </div>
